...
dashes
*/
gamescene32::gamescene32(int x,int y,int z)
{
    mylevel =x;
    numLetters =y;
    letter_eval= NULL;
    allowed_attempts = z;
    game_criminal = new criminal32();
    addItem(game_criminal);
    game_criminal->setFlag(QGraphicsItem::ItemIsFocusable);
    game_criminal->setFocus();
    normal_ground = new ground32(0);
...
void gamescene32::addground(int x){
    normal_ground = new ground32(x);
...
*/
void gamescene32::addhole(int x){
    trap_hole = new hole32(x);
    addItem(trap_hole);
...
*/
void gamescene32::add_dash(int x){

    letter_dash = new dash32(x);
    addItem(letter_dash);
...
*/
void gamescene32::move_criminal(bool w,QString a){
